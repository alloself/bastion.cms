<section id='block-9ffeb6a8-4621-4ab5-b893-cca63b06dc01' class="app-about-head-block pt-[100px] lg:pt-[140px] pb-10 lg:pb-16">
    <div class="centered">
        <div class="xl:w-1/2">
            <div class="text-simple text-brand text-opacity-60 mb-2"><?php echo e($contentBlock->link->subtitle); ?></div>
            <h1 class="h2"><?php echo e($contentBlock->link->title); ?></h1>
...
</section><?php /**PATH /var/www/storage/framework/views/f46de4d83f5b000a4705d1ec054af084.blade.php ENDPATH**/ ?>