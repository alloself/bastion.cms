...
<section id='block-9ffeb885-8e26-4774-8159-fb0439164b29' class="app-about-history-head bg-stone bg-opacity-30 py-8 lg:py-14">
    <div class="centered">
        <div class="flex flex-col mb-8 lg:mb-14 lg:flex-row">
            <div class="text-brand text-opacity-60 text-simple lg:pr-4 lg:w-1/4"><?php echo e($contentBlock->link->subtitle); ?></div>
            <h2 class="mb-0 lg:w-3/4"><?php echo e($contentBlock->link->title); ?></h2>
        </div>
...
<div id='block-9ffeb885-8e26-4774-8159-fb0439164b29' class="py-12 flex gap-1 justify-center">
    <?php if(isset($link)): ?>
        ...
        >+</a>
    <?php endif; ?>
</div><?php /**PATH /var/www/storage/framework/views/3a008a2da62ee2a112089641bb1d1981.blade.php ENDPATH**/ ?>