...
<section id='block-9ffed235-28a9-45ab-8c91-67ba16da31d8' class="py-10 bg-stone/30">
    <div class="centered">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center">
            <div class="text-simple text-brand/60 flex-none lg:w-1/3">{{$subtitle}}</div>
            <div class="lg:flex-1 lg:min-w-0">
                ...
                <div class="lg:pl-[25%]">
                    ...
                    <div class="flex flex-wrap gap-1 mt-6">
                        <a href="{{$more_url}}" class="app-button app-button--primary flex-1 min-w-0 sm:flex-none">Подробнее</a>
                        <a href="{{$plus_url}}" class="app-button app-button--primary app-button--square">+</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="my-10 relative select-none swiper js-centered-gallery-slider">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide w-[300px] md:w-[640px]">
                    <img src="{{ $s['image'] ?? '/img/gallery-image.png' }}" alt="{{ $s['alt'] ?? '' }}" />
                </div>
                @endforeach
            </div>
