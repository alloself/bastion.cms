...
<div id='block-9fee6c29-3eb6-4608-949f-8b66199655f8' class="app-services-desc-item mb-6">
    <div class="flex items-center gap-3 lg:gap-10 lg:items-end">
        ...
        <div class="font-medium leading-[1.2] text-[22px] lg:flex-1 lg:text-[28px] lg:pb-2 lg:border-b lg:border-opacity-30 lg:border-light">{{$contentBlock->link->title}}</div>
    </div>
