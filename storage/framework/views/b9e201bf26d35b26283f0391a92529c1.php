    ...
    <div class="centered relative">
        ...
        <div class="flex py-5 md:py-8">
            <div class="md:w-1/2 md:ml-auto xl:w-1/4 md:pl-4">
                <div class="font-medium leading-[1.1] mb-5 text-[32px] lg:text-[58px] lg:mb-8"><?php echo e($global->link->subtitle); ?></div>
                <div class="text-[12px] md:text-[13px] text-opacity-60 text-brand"><?php echo e($slogan); ?></div>
            </div>
            ...
            <nav class="mx-auto hidden lg:block">
                <ul class="flex items-center gap-5 text-[13px] text-dark text-opacity-70">
                    <?php $__currentLoopData = $navigation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nav_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <li><a href="<?php echo e($nav_link->url); ?>" class="decor-link <?php echo e(isActivePage($nav_link->url)); ?>"><?php echo e($nav_link->title); ?></a></li>
...
</header><?php /**PATH /var/www/storage/framework/views/3041a52ee9e98a8e37b459048282e592.blade.php ENDPATH**/ ?>