            ...
            <div class="relative flex items-center justify-between py-2.5 min-h-[44px]">
                ...
                <nav class=" leading-[1.3] font-medium hidden md:block lg:text-base text-[14px]">
                    <ul class="select-none flex items-center justify-center gap-5 lg:gap-8">
                        <li><a href="/front-osvetim/catalog"
                                class="decor-link [&.is-active-link]:text-brand">Каталог</a></li>
                        <li><a href="/front-osvetim/about" class="decor-link [&.is-active-link]:text-brand">О
                                нас</a></li>                            
                        <li><a href="/front-osvetim/contacts"
                                class="decor-link [&.is-active-link]:text-brand">Контакты</a></li>
                    </ul>
                </nav>
                <appsearch></appsearch>
            </div>
